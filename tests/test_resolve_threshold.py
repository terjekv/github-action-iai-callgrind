...
class ResolveThresholdTests(unittest.TestCase):
    ...
    def test_conflicting_specific_names_fail_clearly(self) -> None:
        with self.assertRaisesRegex(
            ValueError,
            "conflicting Gungraun thresholds.*regression_threshold_pct_gungraun",
        ):
            resolve_threshold.resolve_gungraun_threshold(3, 4, 5)
    ...
    def test_cli_rejects_conflicts(self) -> None:
        ...
        self.assertIn("conflicting Gungraun thresholds", completed.stderr)
